<?php $__env->startSection('title', 'Home Two || techguru || IT Solutions & Technology Laravel Template'); ?>
...
<?php endif; ?>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="main-slider__shape-1 img-bounce">
                        <img src="<?php echo e(asset('assets/images/shapes/main-slider-shape-1.png')); ?>" alt="">
                    </div>
                    <div class="main-slider__shape-2"></div>
                    <div class="main-slider__shape-3">
                        <img src="<?php echo e(asset('assets/images/shapes/main-slider-shape-3.png')); ?>" alt="">
                    </div>
                    <div class="main-slider__shape-4">
                        <img src="<?php echo e(asset('assets/images/shapes/main-slider-shape-4.png')); ?>" alt="">
                    </div>
                    <div class="main-slider__shape-5">
                        <img src="<?php echo e(asset('assets/images/shapes/main-slider-shape-5.png')); ?>" alt="">
                    </div>
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="main-slider__content">
                                    ...
                                    <div class="main-slider__img">
                                        <img src="<?php echo e(asset('assets/images/resources/main-slider-img-1.png')); ?>"
                                            alt="">
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="main-slider__content">
                                    ...
                                    <div class="main-slider__img">
                                        <img src="<?php echo e(asset('assets/images/resources/main-slider-img-2.png')); ?>"
                                            alt="">
                                    </div>
                                    <div class="main-slider__video-link">
                                        <a href="https://www.youtube.com/watch?v=Get7rqXYrbQ" class="video-popup">
    ...
    <section class="servces-one">
        ...
        <div class="servces-one__shape-3 float-bob-y">
            <img src="<?php echo e(asset('assets/images/shapes/services-one-shape-3.png')); ?>" alt="">
        </div>
        <div class="container">
                    ...
                    <div class="col-xl-5">
                        <div class="servces-one__img-box wow slideInLeft" data-wow-delay="100ms"
                            ...
                            <div class="servces-one__img">
                                <img src="<?php echo e(asset('assets/images/services/servces-one-img-1.png')); ?>" alt="">
                            </div>
                            <div class="servces-one__img-2">
                                <img src="<?php echo e(asset('assets/images/services/servces-one-img-2.png')); ?>" alt="">
                            </div>
                            <div class="servces-one__shape-1">
                                <img src="<?php echo e(asset('assets/images/shapes/services-one-shape-1.png')); ?>" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-7">
                                ...
                                <li>
                                    <div class="services-one__services-single">
                                        <div class="services-one__count-and-content">
                                            ...
                                            <div class="services-one__content">
                                                <h3 class="services-one__title"><a
                                                        href="<?php echo e(route('threat-detection-prevention')); ?>">Provide All Kind
                                                        Of
                                                        IT
                                                        Services</a></h3>
                                        ...
                                        <div class="services-one__arrow">
                                            <a href="<?php echo e(route('threat-detection-prevention')); ?>"><span
                                                    class="icon-right-arrow"></span></a>
                                        </div>
                                    </div>
                                    <div class="services-one__hover-img">
                                        <img src="<?php echo e(asset('assets/images/services/services-1-1.jpg')); ?>" alt="Image">
                                    </div>
                                </li>
                                <li>
                                    <div class="services-one__services-single">
                                        <div class="services-one__count-and-content">
                                            ...
                                            <div class="services-one__content">
                                                <h3 class="services-one__title"><a
                                                        href="<?php echo e(route('advanced-technology')); ?>">Cybersecurity
                                                        Solutions</a>
                                                </h3>
                                        ...
                                        <div class="services-one__arrow">
                                            <a href="<?php echo e(route('advanced-technology')); ?>"><span
                                                    class="icon-right-arrow"></span></a>
                                        </div>
                                    </div>
                                    <div class="services-one__hover-img">
                                        <img src="<?php echo e(asset('assets/images/services/services-1-2.jpg')); ?>" alt="Image">
                                    </div>
                                </li>
                                <li>
                                    <div class="services-one__services-single">
                                        ...
                                        <div class="services-one__arrow">
                                            <a href="<?php echo e(route('data-protection-privacy')); ?>"><span
                                                    class="icon-right-arrow"></span></a>
                                        </div>
                                    </div>
                                    <div class="services-one__hover-img">
                                ...
                                <li>
                                    <div class="services-one__services-single">
                                        <div class="services-one__count-and-content">
                                            ...
                                            <div class="services-one__content">
                                                <h3 class="services-one__title"><a
                                                        href="<?php echo e(route('backup-recovery')); ?>">Software Development &
                                                        Integration</a></h3>
                                        ...
                                        <div class="services-one__arrow">
                                            <a href="<?php echo e(route('backup-recovery')); ?>"><span
                                                    class="icon-right-arrow"></span></a>
                                        </div>
                                    </div>
                                    <div class="services-one__hover-img">
                    ...
                    <div class="about-one__left">
                        ...
                        <div class="about-one__btn-and-call-box">
                            <div class="about-one__btn-box">
                                <a href="<?php echo e(route('about')); ?>" class="thm-btn">Get in Touch<span
                                        class="icon-right-arrow"></span></a>
                            </div>
    ...
    <section class="portfolio-one">
        ...
        <div class="portfolio-one__shape-1">
            <img src="<?php echo e(asset('assets/images/shapes/portfolio-one-shape-1.png')); ?>" alt="">
        </div>
        <div class="portfolio-one__shape-2">
            <img src="<?php echo e(asset('assets/images/shapes/portfolio-one-shape-2.png')); ?>" alt="">
        </div>
        <div class="container">
            <div class="portfolio-one__top">
                ...
                <a href="<?php echo e(route('portfolio')); ?>" class="portfolio-one__round-text-box">
                    <div class="portfolio-one__round-text-box-outer">
                        <div class="portfolio-one__round-text-box-inner">
                            ...
                            <div class="portfolio-one__round-icon">
                                <img src="<?php echo e(asset('assets/images/icon/portfolio-one-round-icon.png')); ?>" alt="">
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="portfolio-one__carousel owl-carousel owl-theme">
                    ...
                    <div class="portfolio-one__single">
                        ...
                        <div class="portfolio-one__content">
                            <div class="portfolio-one__title-box">
                                <h3 class="portfolio-one__title"><a href="">Innovative
                                        Digital
                ...
                <div class="item">
                    <div class="portfolio-one__single">
                        ...
                        <div class="portfolio-one__content">
                            <div class="portfolio-one__title-box">
                                <h3 class="portfolio-one__title"><a href="">Empowering
                ...
                <div class="item">
                    <div class="portfolio-one__single">
                        ...
                        <div class="portfolio-one__content">
                            <div class="portfolio-one__title-box">
                                <h3 class="portfolio-one__title"><a href="">Transforming
                                        Ideas
                ...
                <div class="item">
                    <div class="portfolio-one__single">
                        ...
                        <div class="portfolio-one__content">
                            <div class="portfolio-one__title-box">
                                <h3 class="portfolio-one__title"><a href="">Driving
                                        Digital
                ...
                <div class="item">
                    <div class="portfolio-one__single">
                        ...
                        <div class="portfolio-one__content">
                            <div class="portfolio-one__title-box">
                                <h3 class="portfolio-one__title"><a href="">Seamless Tech
                ...
                <div class="item">
                    <div class="portfolio-one__single">
                        ...
                        <div class="portfolio-one__content">
                            <div class="portfolio-one__title-box">
                                <h3 class="portfolio-one__title"><a href="">Future-Ready
                                        IT
                ...
                <div class="col-xl-4 col-lg-6 wow fadeInLeft" data-wow-delay="100ms">
                    <div class="pricing-one__single">
                        <div class="pricing-one__icon">
                            <img src="<?php echo e(asset('assets/images/icon/pricing-icon-1.png')); ?>" alt="">
                        </div>
                        ...
                        <div class="pricing-one__btn-box">
                            <a href="<?php echo e(route('pricing')); ?>" class="pricing-one__btn">Choose Plan<span
    ...
    <section class="testimonial-one">
        <div class="testimonial-one__bg"
            style="background-image: url(<?php echo e(asset('assets/images/backgrounds/testimonial-one-bg-1.jpg')); ?>);"></div>
        <div class="testimonial-one__shape-1"></div>
        <div class="testimonial-one__shape-2 float-bob-y">
            <img src="<?php echo e(asset('assets/images/shapes/testimonial-one-shape-2.png')); ?>" alt="">
        </div>
        <div class="container">
            <div class="row">
                        ...
                        <div class="testimonial-one__carousel owl-theme owl-carousel">
                                ...
                                <div class="testimonial-one__single">
                                    <div class="testimonial-one__img-box">
                                        <div class="testimonial-one__img">
                                            <img src="<?php echo e(asset('assets/images/testimonial/testimonial-1-1.jpg')); ?>"
                                                alt="">
                                        </div>
                                    </div>
                                            ...
                                            <div class="testimonial-one__quote-and-client-info">
                                                ...
                                                <div class="testimonial-one__client-info">
                                                    ...
                                                    <h3 class="testimonial-one__client-name"><a
                                                            href="<?php echo e(route('testimonials')); ?>">Sarah Collins</a></h3>
                                                </div>
                                            </div>
                                            <div class="testimonial-one__trustpilot-box">
                                                <div class="testimonial-one__trustpilot-logo">
                                                    <img src="<?php echo e(asset('assets/images/resources/trustpilot-logo.png')); ?>"
                                                        alt="">
                                                </div>
                                                    ...
                                                    <ul class="list-unstyled testimonial-one__trustpilot-star-list">
                                                        <li>
                                                            <div class="testimonial-one__trustpilot-star-icon">
                                                                <img src="<?php echo e(asset('assets/images/icon/star-icon.png')); ?>"
                                                                    alt="">
                                                            </div>
                                                        </li>
                                                        <li>
                            ...
                            <div class="item">
                                <div class="testimonial-one__single">
                                    <div class="testimonial-one__img-box">
                                        <div class="testimonial-one__img">
                                            <img src="<?php echo e(asset('assets/images/testimonial/testimonial-1-2.jpg')); ?>"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="testimonial-one__content">
                                        ...
                                        <div class="testimonial-one__bottom">
                                            <div class="testimonial-one__quote-and-client-info">
                                                ...
                                                <div class="testimonial-one__client-info">
                                                    ...
                                                    <h3 class="testimonial-one__client-name"><a
                                                            href="<?php echo e(route('testimonials')); ?>">Collins Munro</a></h3>
                                                </div>
                                            </div>
                                            <div class="testimonial-one__trustpilot-box">
                                                <div class="testimonial-one__trustpilot-logo">
                            ...
                            <div class="item">
                                <div class="testimonial-one__single">
                                    <div class="testimonial-one__img-box">
                                        <div class="testimonial-one__img">
                                            <img src="<?php echo e(asset('assets/images/testimonial/testimonial-1-3.jpg')); ?>"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="testimonial-one__content">
                                        ...
                                        <div class="testimonial-one__bottom">
                                            <div class="testimonial-one__quote-and-client-info">
                                                ...
                                                <div class="testimonial-one__client-info">
                                                    ...
                                                    <h3 class="testimonial-one__client-name"><a
                                                            href="<?php echo e(route('testimonials')); ?>">Sarah James</a></h3>
                                                </div>
                                            </div>
                                            <div class="testimonial-one__trustpilot-box">
                                                <div class="testimonial-one__trustpilot-logo">
                            ...
                            <ul class="list-unstyled brand-one__img-list">
                                <li>
                                    <div class="brand-one__img-box">
                                        <img src="<?php echo e(asset('assets/images/brand/brand-one-img-1-1.jpg')); ?>"
                                            alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="brand-one__img-box">
                                        <img src="<?php echo e(asset('assets/images/brand/brand-one-img-1-2.jpg')); ?>"
                                            alt="">
                                    </div>
                                </li>
                            </ul>
        ...
        <div class="container">
            <div class="newsletter-one__inner">
                <div class="newsletter-one__shape-bg"
                    style="background-image: url(<?php echo e(asset('assets/images/shapes/newsletter-one-shape-bg.png')); ?>);">
                </div>
                <div class="newsletter-one__shape-1 float-bob-x">
                    <img src="<?php echo e(asset('assets/images/shapes/newsletter-one-shape-1.png')); ?>" alt="">
                </div>
                <div class="newsletter-one__shape-2"></div>
                <div class="newsletter-one__shape-3"></div>
                <div class="newsletter-one__img float-bob-y">
                    <img src="<?php echo e(asset('assets/images/resources/newsletter-one-img-1.png')); ?>" alt="">
                </div>
                        ...
                        <div class="blog-one__content">
                            <div class="blog-one__user">
                                <div class="blog-one__user-img">
                                    <img src="<?php echo e(asset('assets/images/blog/blog-one-user-1.jpg')); ?>" alt="">
                                </div>
                            ...
                            <h3 class="blog-one__title"><a href="<?php echo e(route('blog-details')); ?>">Top IT Trends Shaping
                                    the Future
                ...
                <div class="item">
                    <div class="blog-one__single">
                        ...
                        <div class="blog-one__content">
                            <div class="blog-one__user">
                                <div class="blog-one__user-img">
                                    <img src="<?php echo e(asset('assets/images/blog/blog-one-user-2.jpg')); ?>" alt="">
                                </div>
                                <p class="blog-one__user-title">Alisa Olivia</p>
                            </div>
                            <ul class="blog-one__meta list-unstyled">
                            ...
                            <h3 class="blog-one__title"><a href="<?php echo e(route('blog-details')); ?>">Cybersecurity Best
                                    Practices
                ...
                <div class="item">
                    <div class="blog-one__single">
                        ...
                        <div class="blog-one__content">
                            <div class="blog-one__user">
                                <div class="blog-one__user-img">
                                    <img src="<?php echo e(asset('assets/images/blog/blog-one-user-3.jpg')); ?>" alt="">
                                </div>
                            ...
                            <ul class="blog-one__meta list-unstyled">
                                ...
                                <li>
                                    <a href="<?php echo e(route('blog-details')); ?>"><span class="fal fa-comments"></span>88
                                        Comments</a>
                                </li>
                            </ul>
                            <h3 class="blog-one__title"><a href="<?php echo e(route('blog-details')); ?>">Cloud Computing vs.
                                    On-Premise
                ...
                <div class="item">
                    <div class="blog-one__single">
                        ...
                        <div class="blog-one__content">
                            <div class="blog-one__user">
                                <div class="blog-one__user-img">
                                    <img src="<?php echo e(asset('assets/images/blog/blog-one-user-4.jpg')); ?>" alt="">
                                </div>
                            ...
                            <ul class="blog-one__meta list-unstyled">
                                ...
                                <li>
                                    <a href="<?php echo e(route('blog-details')); ?>"><span class="fal fa-comments"></span>20
                                        Comments</a>
                                </li>
                            </ul>
                            <h3 class="blog-one__title"><a href="<?php echo e(route('blog-details')); ?>">The Role of AI in Modern
                ...
                <div class="item">
                    <div class="blog-one__single">
                        ...
                        <div class="blog-one__content">
                            ...
                            <h3 class="blog-one__title"><a href="<?php echo e(route('blog-details')); ?>">Why IT Support is
                                    Essential for
...
<?php echo $__env->make('layouts.layout2', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/khanhhoa/sites/techguru/resources/views/home/index2.blade.php ENDPATH**/ ?>
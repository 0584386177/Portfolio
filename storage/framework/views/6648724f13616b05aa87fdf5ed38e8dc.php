<?php $__env->startSection('title', 'Services || techguru || IT Solutions & Technology Laravel Template'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Our Services','subtitle' => 'Our Services']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Our Services','subtitle' => 'Our Services']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <section class="services-four">
            <div class="services-four__bg-shape float-bob-y"
                style="background-image: url(<?php echo e(asset('assets/images/shapes/services-four-bg-shape.png')); ?>);"></div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
                        <div class="services-four__left wow slideInLeft" data-wow-delay="100ms"
                            ...
                            <div class="services-four__img-box">
                                <div class="services-four__img">
                                    <img src="<?php echo e(asset('assets/images/services/services-four-img-1.jpg')); ?>" alt="">
                                </div>
                                <div class="services-four__img-2">
                                    <img src="<?php echo e(asset('assets/images/services/services-four-img-2.jpg')); ?>" alt="">
                                    <div class="services-four__qualified-box">
                                        <div class="services-four__qualified-icon">
                                            <img src="<?php echo e(asset('assets/images/icon/services-four-qualified-icon.png')); ?>" alt="">
                                        </div>
                                ...
                                <div class="services-four__shape-1">
                                    <img src="<?php echo e(asset('assets/images/shapes/services-four-shape-1.png')); ?>" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.layout4', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/khanhhoa/sites/techguru/resources/views/pages/services.blade.php ENDPATH**/ ?>
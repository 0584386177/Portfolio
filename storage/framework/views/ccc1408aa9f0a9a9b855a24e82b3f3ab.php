<?php $__env->startSection('title', 'Threat Detection & Prevention || techguru || IT Solutions & Technology Laravel Template'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Threat Detection & Prevention','subtitle' => 'Threat Detection & Prevention']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Threat Detection & Prevention','subtitle' => 'Threat Detection & Prevention']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <section class="services-details">
        ...
        <div class="services-details__shape-2">
            <img src="<?php echo e(asset('assets/images/shapes/services-details-shape-2.png')); ?>" alt="">
        </div>
        <div class="container">
            <div class="row">
                    ...
                    <div class="services-details__left">
                        <div class="services-details__services-list-box">
                            ...
                            <ul class="services-details__services-list list-unstyled">
                                <li class="active">
                                    <a href="<?php echo e(route('threat-detection-prevention')); ?>">Threat Detection & Prevention<span
                                            class="icon-right-arrow-2"></span></a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('endpoint-device-security')); ?>">Endpoint & Device Security<span
                                            class="icon-right-arrow-2"></span></a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('data-protection-privacy')); ?>">Data Protection & Privacy<span
                                            class="icon-right-arrow-2"></span></a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('backup-recovery')); ?>">Backup & Recovery<span
                                            class="icon-right-arrow-2"></span></a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('advanced-technology')); ?>">Advanced Technology<span
                                            class="icon-right-arrow-2"></span></a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('cloud-managed-services')); ?>">Cloud managed services<span
                                            class="icon-right-arrow-2"></span></a>
                                </li>
                            </ul>
                        </div>
                        <div class="services-details__need-help">
                            <div class="services-details__need-help-img">
                                <img src="<?php echo e(asset('assets/images/services/services-details-need-help-img.jpg')); ?>"
                                    alt="">
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="services-details__right">
                        ...
                        <div class="services-details__img-1">
                            <img src="<?php echo e(asset('assets/images/services/services-details-img-1.jpg')); ?>" alt="">
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="services-details__img-box-img">
                                        <img src="<?php echo e(asset('assets/images/services/services-details-img-box-img-1.jpg')); ?>"
                                            alt="">
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="services-details__img-box-img">
                                        <img src="<?php echo e(asset('assets/images/services/services-details-img-box-img-2.jpg')); ?>"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="services-details__bottom-img">
                            <img src="<?php echo e(asset('assets/images/services/services-details-bottom-img.jpg')); ?>"
                                alt="">
                        </div>
...
<?php echo $__env->make('layouts.layout4', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/khanhhoa/sites/techguru/resources/views/pages/threat-detection-prevention.blade.php ENDPATH**/ ?>
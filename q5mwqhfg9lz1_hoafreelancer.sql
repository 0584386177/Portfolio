...
-- Thời gian đã tạo: Th10 11, 2025 lúc 02:21 PM
...
--
-- Cơ sở dữ liệu: `q5mwqhfg9lz1_hoafreelancer`
--
...
INSERT INTO `categories_post` (`id`, `name`, `slug`, `created_at`, `updated_at`) VALUES
(1, 'Google  API', 'google-api', '2025-10-03 15:59:36', '2025-10-03 15:59:36'),
(2, 'Wordpress', 'wordpress', '2025-10-03 16:03:46', '2025-10-03 16:03:46'),
(3, 'Server', 'server', '2025-10-03 16:04:52', '2025-10-03 16:04:52'),
(4, 'Hosting', 'hosting', '2025-10-03 16:05:38', '2025-10-03 16:05:38');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `category_software`
--

CREATE TABLE `category_software` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `category_software`
--

INSERT INTO `category_software` (`id`, `parent_id`, `name`, `slug`, `created_at`, `updated_at`) VALUES
(2, NULL, 'Phần mềm đồ họa', 'phan-mem-do-hoa', '2025-10-10 08:55:57', '2025-10-10 08:55:57'),
(3, 2, 'Adobe Photoshop', 'adobe-photoshop', '2025-10-10 08:59:36', '2025-10-10 08:59:36'),
(4, 2, 'Adobe InDesign', 'adobe-indesign', '2025-10-10 09:00:28', '2025-10-10 09:00:41'),
(5, 2, 'CorelDRAW', 'coreldraw', '2025-10-10 09:01:20', '2025-10-10 09:01:20'),
(6, NULL, 'Phần mềm xây dựng', 'phan-mem-xay-dung', '2025-10-11 03:21:53', '2025-10-11 03:21:53'),
(7, 6, 'AutoDesk AutoCad', 'autodesk-autocad', '2025-10-11 03:22:18', '2025-10-11 03:22:18'),
(8, NULL, 'Phần mềm giáo viên', 'phan-mem-giao-vien', '2025-10-11 03:23:42', '2025-10-11 03:23:42'),
(9, 8, 'Math Type', 'math-type', '2025-10-11 03:24:14', '2025-10-11 03:24:20'),
(10, 8, 'Physics Draw Word', 'physics-draw-word', '2025-10-11 03:25:21', '2025-10-11 03:25:21'),
(11, NULL, 'Phần mềm xử lý dữ liệu', 'phan-mem-xu-ly-tai-lieu', '2025-10-11 03:26:38', '2025-10-11 03:26:38'),
(12, 11, 'ABBYY FineReader', 'abbyy-finereader', '2025-10-11 03:26:58', '2025-10-11 03:26:58'),
(13, 11, 'Foxit PDF Editor Pro', 'foxit-pdf-editor-pro', '2025-10-11 03:27:59', '2025-10-11 03:27:59'),
(14, NULL, 'Phần mềm văn phòng', 'phan-mem-van-phong', '2025-10-11 03:28:37', '2025-10-11 03:28:37'),
(15, 14, 'Office 365', 'office-365', '2025-10-11 03:29:05', '2025-10-11 03:29:05'),
(16, 14, 'Office 2021 for MacOs', 'office-2021-for-macos', '2025-10-11 03:29:38', '2025-10-11 03:29:38'),
(17, 11, 'Nitro Pro ', 'nitro-pro', '2025-10-11 03:33:36', '2025-10-11 03:33:36');
...
INSERT INTO `software` (`id`, `user_id`, `category_id`, `name`, `slug`, `version`, `description`, `thumbnail`, `file_path`, `file_size`, `download_count`, `is_active`, `created_at`, `updated_at`) VALUES
(10, 1, 14, 'Phần mềm Office 365 ', 'phan-mem-office-365', '2024', '<p>Phần mềm Office 365 Full Crack</p>', 'software/hero-image.webp', 'FILE CÀI ĐẶT PHẦN MỀM/files/Office 365.zip', 3395517, 15, 1, '2025-10-05 07:00:21', '2025-10-11 05:24:47'),
(11, 1, 3, 'Adobe Photoshop CC 2020', 'adobe-photoshop-cc-2020', '2020', '<p>Adobe Full bọ cài Crack Photoshop 2020</p>', 'software/Adobe-Photoshop-CC-2020.webp', 'FILE CÀI ĐẶT PHẦN MỀM/files/Photoshop 2020 KhanhHoa 0584386177.rar', 1288490188, 5, 1, '2025-10-06 14:40:19', '2025-10-10 01:58:57'),
(12, 1, 10, 'Physics Draw Word 2025', 'physics-draw-word-2025', '1.0', '<p>Phần mềm vẽ vật lý cho giáo viên</p>', 'software/noimage.png', 'FILE CÀI ĐẶT PHẦN MỀM/files/Phan_mem_ve_hinh_Vat_li_tren_Word_PHYSICS_DRAW.zip', 761856, 2, 1, '2025-10-08 16:37:00', '2025-10-10 15:12:38'),
(13, 1, 11, 'EaseUS Data Recovery', 'easeus-data-recovery', '16.5', '<p>Phần mềm lấy lại dữ liệu khi recovery ổ cưng trên máy tính (EaseUS Data Recovery Wizard Technician )</p>', 'software/1701693783_easeus-data-recovery-wizard_story.jpg', 'FILE CÀI ĐẶT PHẦN MỀM/files/EaseUS Data Recovery Wizard Technician 16.5.0.0.rar', 73714893, 1, 1, '2025-10-08 16:52:27', '2025-10-10 00:40:26'),
(14, 1, 12, 'ABBYY FineReader Full ', 'abbyy-finereader-full', '14', '<p></p>', 'software/aabbyy-14.jfif', 'FILE CÀI ĐẶT PHẦN MỀM/files/ABBYY_FineReader_Full_14.rar', 425721856, 1, 1, '2025-10-08 17:14:02', '2025-10-10 02:34:21'),
(15, 1, 13, 'Foxit PDF Editor Pro 2024', 'foxit-pdf-editor-pro-2024', '2024', '<p>Phần mềm đọc ghi convert PDF FOXIT</p>', 'software/Foxit PDF Editor Pro 2024.png', 'FILE CÀI ĐẶT PHẦN MỀM/files/Foxit PDF Editor Pro 2024.zip', NULL, 1, 1, '2025-10-08 17:23:28', '2025-10-10 00:12:29'),
(16, 1, 7, 'AutoDesk AutoCad 2019', 'autodesk-autocad-2019', '2019', '<p>Phần mềm xây dựng bản vẽ chuyên cho xây dựng</p>', 'software/autodesk-auto-cad-2019.webp', 'FILE CÀI ĐẶT PHẦN MỀM/files/Auto CAD_2019.rar', 2405181686, 1, 1, '2025-10-08 17:28:31', '2025-10-10 01:22:04'),
(17, 1, 16, 'Office 365 for MacOs', 'office-365-for-macos', '2021 MacOs', '<p>Trọn bộ office 365 dành cho MacOs</p>', 'software/office-365-for-macos.jfif', 'FILE CÀI ĐẶT PHẦN MỀM/files/Office_2021_MacOS.zip', 1889785610, 6, 1, '2025-10-08 17:36:04', '2025-10-11 04:33:40'),
(18, 1, 17, 'Nitro Pro 13 Full Crack', 'nitro-pro-13-full-crack', '13', '<p><strong>Nitro Pro 13</strong> được nhiều người dùng quan tâm bởi phần mềm này hỗ trợ việc tạo mới, xem và chỉnh sửa các file PDF một cách thuận tiện. Đặc biệt, phiên bản 13 còn được nâng cấp với nhiều tính năng nổi trội. Sau đây hãy cùng tìm hiểu rõ hơn về Nitro Pro 13 và quy trình cài đặt phần mềm này nhé.</p>', 'software/nitro-pro-13.jpg', 'FILE CÀI ĐẶT PHẦN MỀM/files/Download Nitro Pro Full Crack Miễn Phí.zip', 717855130, 2, 1, '2025-10-09 09:31:25', '2025-10-10 15:12:29'),
(19, 1, 9, 'Math Type - Soạn công thức', 'math-type-soan-cong-thuc', '7.8.0', '<p>MathType này làm gì, một <strong>trình soạn thảo phương trình mạnh mẽ</strong> mà bạn có thể sử dụng với Office hoặc trên chính nó. Điểm mạnh của MathType là hàng trăm biểu tượng có thể truy cập từ bàn phím, cùng với khả năng tương thích với các hệ thống khác nhau để nhập và xuất các công thức, như MathML, TeX hoặc Texvc.</p>', 'software/MathType_img.png', 'FILE CÀI ĐẶT PHẦN MỀM/files/MathType 7.8.0.rar', 45927629, 4, 1, '2025-10-09 09:47:08', '2025-10-11 04:33:16');
...
(1, 'Huynh Khanh Hoa', 'huynhkhanhhoa2010@gmail.com', NULL, '$2y$12$7m7hncbs4crDUsZ9wfS71.G7oAtK30r/1ATDTUVvHZisHCgL.Qqgy', NULL, '2025-10-02 21:47:15', '2025-10-02 21:47:15'),
(2, 'Luong Thi Hong Vy', 'thihongvyluong@gmail.com', NULL, '$2y$12$nR3n0.JlBQdmINTAwGP0UOUz8YP9nmV8E2K9FtVzL/EmzpN.KyCFW', NULL, '2025-10-03 14:39:44', '2025-10-03 14:39:44');
...
--
-- Chỉ mục cho bảng `category_software`
--
ALTER TABLE `category_software`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT cho bảng `category_software`
--
ALTER TABLE `category_software`
...
--
-- Các ràng buộc cho bảng `category_software`
--
ALTER TABLE `category_software`
  ADD CONSTRAINT `category_software_ibfk_1` FOREIGN KEY (`parent_id`) REFERENCES `category_software` (`id`);

--
-- Các ràng buộc cho bảng `posts`
--
ALTER TABLE `posts`
  ADD CONSTRAINT `posts_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories_post` (`id`),
...
--
ALTER TABLE `software`
  ADD CONSTRAINT `software_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `software_ibfk_2` FOREIGN KEY (`category_id`) REFERENCES `category_software` (`id`);
COMMIT;
